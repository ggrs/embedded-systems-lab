...
/*lint -restore Enable MISRA rule (6.3) checking. */
{
  ...
  // 4) Subscribe 
  UTIL1_strcpy(bm,256,"SUBSCRIBE \"EA076/grupoI2/adjust\"");
  Sub_topic(bm);
  ...
  for(;;){
	  ...
	  if (found != -1 && mr == 1) {
		  ...
		  /* Caso o t�pico seja "adjust" envio a temperatura para o display.
		   * 
		   */
		  if(!(UTIL1_strcmp(btopico, "EA076/grupoI2/adjust"))){
			  
			  Display_WriteLineStr(1, bl);
			  Display_WriteLineStr(3, btemp);
